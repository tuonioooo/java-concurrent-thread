...
**1 作者**  
Hashtable的作者：  
![](../../.gitbook/assets/import-hashmap-02.png)  
HashMap的作者：  
![](../../.gitbook/assets/import-hashmap-03.png)
...
![](../../.gitbook/assets/import-hashmap-04.png)

![](../../.gitbook/assets/import-hashmap-05.png)
...
![](../../.gitbook/assets/import-hashmap-06.png)

**5 对Null key 和Null value的支持不同**  
Hashtable既不支持Null key也不支持Null value。Hashtable的put\(\)方法的注释中有说明。  
![](../../.gitbook/assets/import-hashmap-07.png)

当key为Null时，调用put\(\) 方法，运行到下面这一步就会抛出空指针异常。因为拿一个Null值去调用方法了。  
![](../../.gitbook/assets/import-hashmap-08.png)

当value为null值时，Hashtable对其做了限制，运行到下面这步也会抛出空指针异常。  
![](../../.gitbook/assets/import-hashmap-09.png)
...
![](../../.gitbook/assets/import-hashmap-10.png)
...
![](../../.gitbook/assets/import-hashmap-11.png)
...
![](../../.gitbook/assets/import-hashmap-12.png)
