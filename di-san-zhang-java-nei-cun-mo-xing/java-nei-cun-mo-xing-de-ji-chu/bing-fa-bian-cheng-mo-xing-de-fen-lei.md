...
图1![](../../.gitbook/assets/import-category.png)假设处理器A和处理器B按程序的顺序并行执行内存访问，最终可能得到x=y=0的结果。具

体的原因如图2所示。

图2

![](../../.gitbook/assets/import-category-2.png)
...
表3![](../../.gitbook/assets/import-category-3.png)
...
表4![](../../.gitbook/assets/import-category-4.png)
